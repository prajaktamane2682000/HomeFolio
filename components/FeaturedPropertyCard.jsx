      ...
      <div className="p-6">
        ...
        <div className="flex justify-center gap-4 text-green-900 text-sm mb-4">
          {property.rates.nightly && (
            <p>
              <FaMoneyBill className="inline-block mr-2"></FaMoneyBill> Nightly
            </p>
          )}

          {property.rates.weekly && (
            <p>
              <FaMoneyBill className="inline-block mr-2"></FaMoneyBill> Weekly
            </p>
          )}

          {property.rates.monthly && (
            <p>
              <FaMoneyBill className="inline-block mr-2"></FaMoneyBill> Monthly
            </p>
          )}
        </div>
            ...
            <span className="text-orange-700">
              {" "}
              {
                property.location
                  ...
                  : "Location not available" // Default message if location is missing
              }{" "}
            </span>
          </div>
          <Link
